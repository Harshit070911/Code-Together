...
The Code Together is a web-based application that allows multiple users to collaborate on code editing in real time. This project leverages JavaScript, React, Socket.IO, and the Monaco Editor to provide a seamless and interactive coding experience.
...
## Demo
- ![Screenshot 2024-08-05 161441](https://iili.io/f6t34qX.png)
- ![Screenshot 2024-08-05 161333](https://iili.io/f6t361n.png)
...
```sh
git clone https://github.com/Harshit070911/Code-Together
```
